    ...
    <div className="md:mx-10">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600 ">
            <li className="cursor-pointer hover:text-blue-700">+91 9876543210</li>
            <li className="cursor-pointer hover:text-blue-700">itzmemaha1417@gmail.com</li>
          </ul>
        </div>
      </div>
      {/*-----------Copyright----------- */}
      <div>
        <hr />
        <p className="py-5 text-sm text-center">Copyright 2025 @ Maha.dev - All Rights Reserved</p>
      </div>
    </div>
  );
};
